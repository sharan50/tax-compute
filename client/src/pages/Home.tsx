...
function StepContent() {
  ...
  switch (state.currentStep) {
    case 0: return <ImportStep />;
    case 1: return <AssesseeStep />;
    case 2: return <SalaryStep />;
    case 3: return <HousePropertyStep />;
    case 4: return <CapitalGainsStep />;
    case 5: return <OtherSourcesStep />;
    case 6: return <TDSStep />;
    case 7: return <ComputationStep />;
      ...
      <div className="relative overflow-hidden border-b border-border print:hidden">
        ...
        <div className="container relative py-12 lg:py-16">
          ...
          <p className="mt-3 text-base text-muted-foreground max-w-xl leading-relaxed">
            Import your bank statement or enter details manually. 
            Complete tax calculation under the New Tax Regime with instant computation.
          </p>
        </div>
      </div>
